    ...
    <div class="container bg-blue-100 rounded-3xl p-2 mt-14 shadow-md border border-gray-300 border-t-0" v-if="contact">
            ...
            <div class="">
                ...
                <div v-if="contact.phone" class="flex">
                  ...
                  <div class="text-base ml-2 px-2  group flex" >{{contact.phone}}<img class="h-6 w-6  invisible group-hover:visible cursor-pointer" src="https://img.icons8.com/ios-glyphs/30/000000/clipboard.png" @click="copyToClipBoard(contact.phone)"/></div>
                 ...
                 <div v-if="contact.email" class="flex mt-2">
                  ...
                  <div class="text-base ml-2 px-2  group flex">{{contact.email}}<img class="h-6 w-6  invisible group-hover:visible cursor-pointer" src="https://img.icons8.com/ios-glyphs/30/000000/clipboard.png" @click="copyToClipBoard(contact.email)"/></div>
                </div>
