<template>
  <div
    class="container bg-blue-100 rounded-3xl p-2 mt-14 shadow-md border border-gray-300 border-t-0"
    v-if="contact"
  >
    <div
      class="bg-gray-700 rounded-full text-3xl -mt-12 mx-auto w-24 h-24 pt-8 pl-10 shadow-md text-white"
    >
      {{ initial }}
    </div>
    <div class="">
      <p class="text-3xl text-center" v-if="contact.contact_name">
        {{ contact.contact_name }}
      </p>
      <p class="text-base text-center" v-if="contact.company_name">
        {{ contact.company_name }} | {{ contact.designation }}
      </p>
      <div v-if="contact.phone" class="flex">
        ...
        <div class="text-base ml-2 px-2 group flex">
          {{ contact.phone
          }}<img
            class="h-4 w-4 mt-1 invisible group-hover:visible cursor-pointer"
            src="https://img.icons8.com/ios-glyphs/30/000000/clipboard.png"
